"""
Django settings for flowers_today project.
...
print("USER:", os.environ.get("BREVO_SMTP_USER"))
print("KEY:", os.environ.get("BREVO_SMTP_KEY"))
print("FROM:", os.environ.get("BREVO_SMTP_FROM"))
...
ROOT_URLCONF = 'flowers_today.urls'
...
WSGI_APPLICATION = 'flowers_today.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.environ.get("BREVO_SMTP_FROM")
